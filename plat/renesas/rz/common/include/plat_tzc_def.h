...
/* Trusted Firmware(BL31) secure DRAM 0x40010000 - 0x4010DFFF */
#define PLAT_FW_TZC_PROT_DRAM1_BASE		(0x40010000)
...
#if REDUCE_RESERVED_MEM
/* OP-TEE secure DRAM 0x4010E000 - 0x4010EFFF */
#define PLAT_TEE_TZC_PROT_DRAM1_BASE	(0x4010E000)
